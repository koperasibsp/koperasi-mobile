package id.co.bspguard.android.bravo.memberretrievedeposit;
...
public class MainRetrieveDeposit extends AppCompatActivity {

  Button kirim;
  EditText tanggal, jumlah;
  CheckBox checkBox;
  TextView linkSla;
  ...
  String urlPostResign = fungsi.url()+"post-retrieve-deposit";
  String requestPolicyRegister = fungsi.url()+"policy/4";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_member_main_retrieve_deposit);
    ...
    tanggal.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(MainRetrieveDeposit.this, new DatePickerDialog.OnDateSetListener() {
          @Override
    ...
    kirim.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (!validate()) {
          new KAlertDialog(MainRetrieveDeposit.this, KAlertDialog.WARNING_TYPE)
            .setTitleText("Oops...")
        ...
        dt.put("date", date);
        dt.put("jumlah", Integer.parseInt(value));
        ...
        volleyObjectResult = new VolleyObjectResult() {
          ...
          public void resSuccess(String requestType, JSONObject response) {
            ...
            try {
              ...
              if(error){
                new KAlertDialog(MainRetrieveDeposit.this, KAlertDialog.ERROR_TYPE)
                  .setTitleText("Oops...")
              ...
              new KAlertDialog(MainRetrieveDeposit.this, KAlertDialog.SUCCESS_TYPE)
...
//            Toast.makeText(getApplication(), "Network connection problem", Toast.LENGTH_LONG).show();
          }
        };

        volleyObjectService = new VolleyObjectService(volleyObjectResult, MainRetrieveDeposit.this);
  ...
  public boolean validate() {
    ...
    if (value.isEmpty() || Integer.parseInt(jumlah.getText().toString()) == 0) {
      jumlah.setError("jumlah tidak boleh kosong atau 0");
      valid = false;
    } else {
