...
public class ListPinjamanDataSet {
  String id, loan_name, description, tenor, logo, plafon;
  int biaya_admin, batas_pinjaman, biaya_transfer;
  double bunga, bunga_berjalan, provisi, rate_of_interest;
  public ListPinjamanDataSet()
  {

  }

  public ListPinjamanDataSet(String id, String loan_name, String description, String tenor, String logo, String plafon, int biaya_admin, int batas_pinjaman, int biaya_transfer, double bunga, double bunga_berjalan, double provisi, double rate_of_interest) {
    this.id = id;
