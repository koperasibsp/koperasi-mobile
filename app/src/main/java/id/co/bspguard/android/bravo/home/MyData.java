...
public class MyData {
    ...
    public MyData(String id, String image, String deskripsi, String judul, String harga, String rate, String include, String exclude, String term, String harga_family, String harga_group) {
        this.id = id;
        this.image = image;
