...
public class LoanDataSet {
  ...
  public LoanDataSet(String id, String loan_name, String rate_of_interest, String description, String tenor, String logo, String plafon, int biaya_admin, int batas_pinjaman, int biaya_transfer, double bunga, double bunga_berjalan, double provisi) {
    this.id = id;
